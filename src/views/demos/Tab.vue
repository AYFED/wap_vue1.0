<template>
  <div>
    ...
    <tab :animate="false" :line-width=5>
    ...
    <swiper :index.sync="index" height="100px" :show-dots="false">
      <swiper-item v-for="item in list2">
        <div class="tab-swiper ay-center">{{item}} Container</div>
      </swiper-item>
    </swiper>
    <br/>
    ...
    <br/>
    <tab :line-width=2>
      <tab-item :selected="demo3 === item" v-for="(index, item) in list3" :class="{'ay-1px-r': index===0}" @click="demo3 = item">{{item}}</tab-item>
    </tab>
    <br/>
    <br/>
    <br/>
