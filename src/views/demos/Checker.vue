<template>
  <div style="padding: 15px 0;">
    ...
    <br>
    <span class="demo-title">current value is: {{demo1}}</span>
    <br>
    ...
    <br>
    <span class="demo-title">current value is: {{demo1Checkbox | json}}</span>
    <br>
    ...
    <br>
    <span class="demo-title">current value is: {{demo1CheckboxMax | json}}</span>
    <br>
    ...
    <br>
    <span class="demo-title">current value is: {{demo2}}</span>
    <br>
    ...
    <br>
    <span class="demo-title">current value is: {{demo3}}</span>
    <br>
