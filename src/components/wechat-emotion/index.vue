<template>
  <div class="ay-emotion"><slot style="display:none;"></slot></div>
</template>
...
export default {
  ready () {
    ...
    let imgHTML = ''
    if (!this.isGif) {
      imgHTML = this.$interpolate('<span class="ay-static-emotion" style="background:url(https://res.wx.qq.com/mpres/htmledition/images/icon/emotion/default218877.gif) {{backgroundPositionX}}px 0;"></span>')
    } else {
