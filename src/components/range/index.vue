<template>
  <div class="ay-range-input-box" style="position:relative;margin-right:30px;margin-left:50px;">
    <input class="ay-range-input" v-model="value" number>
  </div>
</template>
...
export default {
  ...
  ready () {
    ...
    this.range = new Powerange(this.$el.querySelector('.ay-range-input'), options)
