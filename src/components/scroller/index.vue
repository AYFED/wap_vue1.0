...
<script>
    ...
    import Lazyload from 'vux-xscroll/build/cmd/plugins/lazyload'
    ...
    export default {
        ...
        ready() {
            this.$el.setAttribute('id', `ay-scroller-${this.uuid}`)
            let content = null
            ...
            this._xscroll = new XScroll({
                renderTo: `#ay-scroller-${this.uuid}`,
                lockX: this.lockX,
                lockY: this.lockY,
